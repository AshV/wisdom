# 📜 Wisdom — Author Expansion Roadmap & ToDo

> **Guiding Principle**: *"We preserve the thoughts that have anchored the human soul across centuries and millennia. We honor timeless philosophers, mystics, classic writers, and scientific pioneers — rejecting transient pop-culture celebrity noise, soundbites, and unsourced internet memes."*

---

## 🏛️ Guiding Philosophy: Timeless Thinkers vs. Celebrity Noise

| 🌟 Timeless Thinkers (Included) | 🚫 Ephemeral Celebrities (Strictly Excluded) |
| :------------------------------ | :------------------------------------------- |
| **Historical Staying Power**: Ideas that have guided humanity across decades, centuries, or millennia. | **Transience**: Red-carpet gossip, fleeting social media influencers, reality TV personalities, or modern soundbites. |
| **Primary Source Integrity**: Verifiable in published books, recorded dialogues, poems, essays, or historical manuscripts. | **Unverifiable Memes**: Internet clichés falsely attributed to famous figures ("Insanity is doing the same thing..."). |
| **Depth of Inquiry**: Explores virtue, sorrow, death, courage, self-mastery, love, nature, and the mystery of consciousness. | **Shallow Hype**: Corporate buzzwords, lifestyle flexes, hustle clichés, and consumerist slogans. |
| **Universal Relevance**: Transcends partisan politics, temporary trends, and geographical borders. | **Partisan / Hyper-Local**: Fleeting political debate or ephemeral cultural grievances. |
...
8. [ ] **Epicurus** (341 – 270 BC) — *Epicureanism & Inner Tranquility*
   ...
   - **Themes**: *Ataraxia* (freedom from anxiety), overcoming the dread of death, simple pleasures, friendship as life's highest security.
   - **Current Count**: 3 quotes.

9. [ ] **Heraclitus** (c. 535 – c. 475 BC) — *Philosophy of Flux*
   - **Sources**: *Fragments* (Diels-Kranz).
   - **Themes**: *Panta rhei* (all things flow), unity of opposites, the cosmic fire, character is destiny.
   - **Current Count**: 4 quotes.

10. [ ] **Cicero (Marcus Tullius Cicero)** (106 – 43 BC) — *Roman Stoicism & Civic Virtue*
    - **Sources**: *On Duties* (*De Officiis*), *On Friendship* (*De Amicitia*), *Tusculan Disputations*.
    - **Themes**: Civic conscience, universal justice, eloquence in service of truth, resilience under tyranny.
    - **Current Count**: 5 quotes.

11. [ ] **Musonius Rufus** (c. 30 – 100 AD) — *The Roman Socrates*
    - **Sources**: *Lectures and Sayings*.
    - **Themes**: Daily practice over abstract theorizing, endurance of exile, vegetarianism and simplicity, gender equality in philosophy.
...
22. [ ] **Henry David Thoreau** (1817 – 1862) — *Simplicity & Deliberate Living*
    ...
    - **Themes**: Deliberate living, voluntary simplicity, deep communion with nature, moral conscience against unjust institutions.
    - **Current Count**: 8 quotes.

23. [ ] **Walt Whitman** (1819 – 1892) — *Cosmic Democratic Poetry*
    - **Sources**: *Leaves of Grass*, *Song of Myself*.
    - **Themes**: Celebrating the vast self, democracy of the soul, interconnectedness of every blade of grass, sacredness of the body and earth.
    - **Current Count**: 4 quotes.

24. [ ] **John Muir** (1838 – 1914) — *Wilderness Philosophy*
    - **Sources**: *My First Summer in the Sierra*, *The Mountains of California*, *Our National Parks*.
    - **Themes**: Going to the mountains as returning home, unblemished nature as spiritual sanctuary, universal kinship of all living organisms.
    - **Current Count**: 4 quotes.
...
### 📖 Tier 6: World Literature, Timeless Poetry & Moral Drama

31. [ ] **Leo Tolstoy** (1828 – 1910)
    - **Sources**: *War and Peace*, *Anna Karenina*, *A Confession*, *The Kingdom of God Is Within You*.
    - **Themes**: Moral awakening, simplicity, universal brotherhood, love as the supreme truth of life.
    - **Current Count**: 4 quotes.

32. [ ] **Fyodor Dostoevsky** (1821 – 1881)
    - **Sources**: *The Brothers Karamazov*, *Crime and Punishment*, *Notes from Underground*, *The Idiot*.
    - **Themes**: Beauty saving the world, active love vs abstract benevolence, freedom, conscience, redemptive suffering.
    - **Current Count**: 4 quotes.

33. [ ] **William Shakespeare** (1564 – 1616)
    - **Sources**: Sonnets, *Hamlet*, *King Lear*, *The Tempest*, *Macbeth*, *As You Like It*.
    - **Themes**: The human condition, passing of time, mercy, true nobility of character, grief and devotion.
    - **Current Count**: 6 quotes.

34. [ ] **Johann Wolfgang von Goethe** (1749 – 1832)
    - **Sources**: *Faust*, *Maxims and Reflections*, *Wilhelm Meister*.
...
36. [ ] **Rainer Maria Rilke** (1875 – 1926)
    ...
    - **Themes**: Living the questions, solitude as sanctuary, embracing transformation, turning pain into art.
    - **Current Count**: 5 quotes.

37. [ ] **Emily Dickinson** (1830 – 1886)
    - **Sources**: *The Complete Poems*.
    - **Themes**: Hope with feathers, dwelling in possibility, intense inner vision, the majestic intimacy of mortality.
    - **Current Count**: 4 quotes.

38. [ ] **Mary Oliver** (1935 – 2019)
    - **Sources**: *Wild Geese*, *New and Selected Poems*, *Devotions*, *Upstream*.
    - **Themes**: Reverence for ordinary nature, paying attention as our sacred duty, our one wild and precious life.
    - **Current Count**: 3 quotes.

---

### 🔬 Tier 7: Scientific Wonder, Natural Philosophy & The Cosmos

39. [ ] **Albert Einstein** (1879 – 1955)
    - **Sources**: *The World as I See It*, *Ideas and Opinions*, *Out of My Later Years*.
    - **Themes**: Cosmic religious sense, holy curiosity, mystery as the seed of art and science, imagination, simplicity of life.
    - **Current Count**: 9 quotes.

40. [ ] **Carl Sagan** (1934 – 1996)
    - **Sources**: *Cosmos*, *Pale Blue Dot*, *The Demon-Haunted World*, *Varieties of Scientific Experience*.
    - **Themes**: We are a way for the cosmos to know itself, pale blue dot perspective, wonder guided by skepticism, cosmic humility.
    - **Current Count**: 4 quotes.

41. [ ] **Richard Feynman** (1918 – 1988)
    - **Sources**: *The Pleasure of Finding Things Out*, *Surely You're Joking, Mr. Feynman!*, *The Meaning of It All*.
    - **Themes**: The joy of honest curiosity, humility before nature, doubt as a vital tool for truth, looking beneath appearances.
    - **Current Count**: 4 quotes.

42. [ ] **Leonardo da Vinci** (1452 – 1519)
    - **Sources**: *The Notebooks of Leonardo da Vinci*.
    - **Themes**: Relentless observation, unity of art and science, nature as supreme mentor, endless desire to understand.
    - **Current Count**: 3 quotes.
...
44. [ ] **Martin Luther King Jr.** (1929 – 1968)
    ...
    - **Themes**: Arc of the moral universe, nonviolent resistance, unconditional love (*agape*), inescapable network of mutuality.
    - **Current Count**: 5 quotes.

45. [ ] **Nelson Mandela** (1918 – 2013)
    - **Sources**: *Long Walk to Freedom*, *Conversations with Myself*.
    - **Themes**: Courage as the triumph over fear, human dignity, forgiveness and reconciliation, the patient long view.
    - **Current Count**: 7 quotes.

---

## 🛠️ Step-by-Step Guide for Adding a New 100-Quote Batch

When adding a new batch of 100 quotes for an author:

### 1. Select the Next Sequential Range
- Check the highest current ID in `src/data/quotes/` (e.g. `q1000.json`).
- Assign next range (e.g. `q1001.json` to `q1100.json`).

### 2. Verify Primary Sources
- Sift quotes strictly from verified translations and primary texts.
- Discard apocryphal / misattributed quotes.
...
### 4. Build & Verify
Run the static site build to validate all schemas:
```bash
npm run build
```
Verify that all routes compile with **0 errors**.

### 5. Update Documentation & Roadmap
Mark the author as completed in this `TODO.md` file and update `walkthrough.md`.
